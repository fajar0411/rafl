...
<body>
   ...
   <!-- Ganti Audio di sini -->
   <audio src="serta_mulia.mp3" type="audio/mp3" id="linkmp3" class="sembunyi"></audio>
   ...
   <div id='Content'>
     ...
     <p id="ket">Klik Kadonya ya cantik!</p>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       ...
       <p id="pesan1">Klik semua love di bawah ini yaa!</p>
       <div id="kolombaru">
         <li id="lv1">❤️</li>
         <li id="lv2">❤️</li>
         <li id="lv3">❤️</li>
       ...
       <p id="pesan5" class="gaya2">Ga kerasa ya, hehe..</p>
       <p id="pesan6" class="gaya2">Semoga panjang umur,sehat selalu yaa!!</p>
       <p id="pesan7" class="gaya2">Harus kuat ya cantik buat kedepannya!</p>

       <p id="pesan8" class="gaya2"><a href="projek_cuy.html">klik disini</a></p>
       <p id="pesan9" class="gaya2"><a href="projek_cuy.html">klik disini</a></p>
       <p id="pesan10" class="gaya2"><a href="projek_cuy.html">klik disini</a></p>
     ...
     <!-- Tombol Kirim Pesan -->
     <div id="Tombol"><a href="kado-main/index.html" id="By">&#128140; aku mau ngasih sesuatu buat abil</a></div>

     <!-- Pesan Tambahan -->
     <p id="katatambahan" class="sembunyi"><a href="projek_cuy.html">klik disini</a></p>
